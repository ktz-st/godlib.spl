...
#define random(aLimit) (rand() % (aLimit))
#define Sardonic_Giaccess(aData, aReg) ((void)Giaccess((aData), (aReg)))
...
void inicializamusica(void)
{
	...
	Sardonic_Giaccess(0,reg+0);	/* Fine Picth do Canal A */
	Sardonic_Giaccess(0,reg+1);	/* Course Picth do Canal A */
	Sardonic_Giaccess(0,reg+2);	/* Fine Picth do Canal B */
	Sardonic_Giaccess(0,reg+3);	/* Course Picth do Canal B */
	Sardonic_Giaccess(0,reg+4);	/* Fine Picth do Canal C */
	Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
	Sardonic_Giaccess(31,reg+6);	/* Picth do Ruído */
	Sardonic_Giaccess(56,reg+7);	/* Mixer: Tom nos Canais ABC */
	Sardonic_Giaccess(0,reg+8); 	/* Volume do Canal A */
	Sardonic_Giaccess(0,reg+9); 	/* Volume do Canal B */
	Sardonic_Giaccess(0,reg+10);	/* Volume do Canal C */
	Sardonic_Giaccess(184,reg+11); /* Fine Duração do Envelope */
	Sardonic_Giaccess(11,reg+12);  /* Course Duração do Envelope */
	Sardonic_Giaccess(9,reg+13); /* Tipo de Envelope */
...
void somexplosao(void)
{
	...
	Sardonic_Giaccess(35,reg+7);	/* Ruído nos Canais AB, Tom no Canal C */
	Sardonic_Giaccess(16,reg+8); /* Volume do Canal A, 16: Usa o Envelope */
	Sardonic_Giaccess(sfx01,reg+9); /* Volume do Canal B */
	Sardonic_Giaccess(sfx02,reg+10); /* Volume do Canal C */
	Sardonic_Giaccess(160,reg+11); /* Fine Duração do Envelope */
	Sardonic_Giaccess(15,reg+12);  /* Course Duração do Envelope */
	Sardonic_Giaccess(9,reg+13); /* Tipo de Envelope */
...
void sombomba(void)
{
	...
	Sardonic_Giaccess(7,reg+7);	/* Ruído nos Canais ABC */
	Sardonic_Giaccess(16,reg+8);  /* Volume do Canal A, 16: Usa o Envelope */
	Sardonic_Giaccess(16,reg+9);  /* Volume do Canal B, 16: Usa o Envelope */
	Sardonic_Giaccess(16,reg+10); /* Volume do Canal C, 16: Usa o Envelope */
	Sardonic_Giaccess(112,reg+11); /* Fine Duração do Envelope */
	Sardonic_Giaccess(23,reg+12);  /* Course Duração do Envelope */
	Sardonic_Giaccess(9,reg+13); /* Tipo de Envelope */
...
void sompremio(int i)
{
	...
	{
		case 0:{
			Sardonic_Giaccess(190,reg+4);/* Fine Picth do Canal C */
			Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
			break;
		}
		case 1:{
			Sardonic_Giaccess(125,reg+4);/* Fine Picth do Canal C */
			Sardonic_Giaccess(1,reg+5);	/* Course Picth do Canal C */
			break;
		}
		case 2:{
			Sardonic_Giaccess(95,reg+4);	/* Fine Picth do Canal C */
			Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
			break;
		}
		case 3:{
			Sardonic_Giaccess(63,reg+4);	/* Fine Picth do Canal C */
			Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
			break;
		}
		case 4:{
			Sardonic_Giaccess(127,reg+4);	/* Fine Picth do Canal C */
			Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
			break;
		}
		case 5:{
			Sardonic_Giaccess(254,reg+4);/* Fine Picth do Canal C */
			Sardonic_Giaccess(0,reg+5);	/* Course Picth do Canal C */
			break;
		}
	}
...
void musicplayer(void)
{
	...
	if (nota!=255)
	{
		...
		Sardonic_Giaccess(fine,reg+0);		/* Fine Picth do Canal A */
		Sardonic_Giaccess(course,reg+1);		/* Course Picth do Canal A */
		Sardonic_Giaccess(mixer,reg+7);		/* Mixer */
		Sardonic_Giaccess(volume,reg+8); 	/* Volume do Canal A */
		Sardonic_Giaccess(9,reg+13); 			/* Tipo de Envelope */
	}
	...
	if (nota!=255)
	{
		...
		Sardonic_Giaccess(fine,reg+2);		/* Fine Picth do Canal B */
		Sardonic_Giaccess(course,reg+3);		/* Course Picth do Canal B */
		Sardonic_Giaccess(volume,reg+9); 	/* Volume do Canal B */
		Sardonic_Giaccess(9,reg+13); 			/* Tipo de Envelope */
	}
	...
	if (nota!=255)
	{
		...
		Sardonic_Giaccess(fine,reg+4);		/* Fine Picth do Canal C */
		Sardonic_Giaccess(course,reg+5);		/* Course Picth do Canal C */
		Sardonic_Giaccess(volume,reg+10);	/* Volume do Canal C */
		Sardonic_Giaccess(9,reg+13); 			/* Tipo de Envelope */
	}
